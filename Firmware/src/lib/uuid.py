"""
This is from https://github.com/pfalcon/pycopy-lib/blob/master/uuid/uuid.py
...
def shortUID():
    """
    When you only need a quick, unique ID.

    This only returns the first part of the UID up to the first '-'
    """
